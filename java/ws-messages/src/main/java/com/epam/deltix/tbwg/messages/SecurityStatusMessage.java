...
import rtmath.containers.interfaces.MutableString;

public class SecurityStatusMessage extends MarketMessage implements RecordInterface {
  ...
  public StringBuilder toString(StringBuilder str) {
    ...
    if (hasEntitlementId()) {
      str.append(", \"entitlementId\": ").append(getEntitlementId());
    }
    if (hasTimeStampMs()) {
