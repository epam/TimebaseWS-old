...
public class ConstantArgumentDef {
    ...
    public static ConstantArgumentDef create(ConstantArgument argument) {
        ...
        argumentDef.setMax(StringUtil.isEmpty(argument.max()) ? null: argument.max());
        argumentDef.setMin(StringUtil.isEmpty(argument.min()) ? null: argument.min());
        argumentDef.setDefaultValue(StringUtil.isEmpty(argument.defaultValue()) ? null: argument.defaultValue());
        return argumentDef;
    }
}
