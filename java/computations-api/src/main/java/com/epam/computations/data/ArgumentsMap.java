...
import static epam.rtc.computations.data.base.GenericValueInfo.*;

public class ArgumentsMap implements MutableArguments {

    private final CharSequenceToLongHashMap longs = new CharSequenceToLongHashMap(LONG_NULL);
    private final CharSequenceToIntHashMap ints = new CharSequenceToIntHashMap(INT_NULL);
    private final CharSequenceToShortHashMap shorts = new CharSequenceToShortHashMap(SHORT_NULL);
    private final CharSequenceToByteHashMap bytes = new CharSequenceToByteHashMap(BYTE_NULL);

    private final CharSequenceToFloatHashMap floats = new CharSequenceToFloatHashMap(FLOAT_NULL);
    private final CharSequenceToDoubleHashMap doubles = new CharSequenceToDoubleHashMap(DOUBLE_NULL);
    private final CharSequenceToDecimalLongHashMap decimals = new CharSequenceToDecimalLongHashMap(DECIMAL_NULL);
    ...
    public long getDecimal(String key, long defaultValue) {
        long value = longs.get(key);
        return isDecimalNull(value) ? defaultValue : value;
    }
