...
import { DEFAULT_DATE_FORMAT, DEFAULT_TIME_FORMAT }       from '../../../../shared/locale.timezone';
...
export function reducer(state = initialState, action: StreamDetailsActions): State {
  switch (action.type) {
