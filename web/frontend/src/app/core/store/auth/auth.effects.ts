...
import { AuthActionTypes, SsoConfigDependentAction }                                       from './auth.actions';
import { AuthProviderModel }                                                               from '../../../models/auth-provider.model';
import { HttpClient, HttpHeaders }                                                         from '@angular/common/http';
import { getAuthProvider, getSSOConfiguration, getSSOProviderConfigUrl, getTokenResponse } from './auth.selectors';
...
import { AuthFlow, SilentAuthProvider } from '@deltix/sso-auth';
...
export class AuthEffects {
  ...
  @Effect({dispatch: false}) silentUpdateSSOToken = this.actions$
    .pipe(
      ...
      tap(([config, appProviderConfig]: [AuthorizationServiceConfiguration, AuthProviderModel]) => {
